  ...
  const plans = [
    {
      ...
      icon: Scale,
      features: [
        "Up to 50 AI consultations per month",
    ...
    },
    {
      ...
      icon: Zap,
      features: [
        "Up to 200 AI consultations per month",
        "Advanced legal research with citations",
        "Document review (up to 200 pages)",
    ...
    },
    {
      ...
      icon: Crown,
      features: [
        "Up to 1000 AI consultations per month",
        "Premium legal research suite",
        "Document review (up to 1000 pages)",
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        >
          <div className="p-8 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 max-w-4xl mx-auto hover:bg-white/10 transition-all duration-500 group">
            ...
            <Button
              onClick={() => handleCheckout(plans[0].priceId, plans[0].name)}
